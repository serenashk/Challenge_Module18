...
def setup():
    ...
    return PyChain([Block(record=Record("Genesis", "Genesis", 0), creator_id=0)])
...
amount_data = st.text_input("Amount Value")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    # Create a new Record with the user-provided values
    new_record = Record(sender=sender_data, receiver=receiver_data, amount=amount_data)
...
# Sidebar for blockchain settings and inspection
